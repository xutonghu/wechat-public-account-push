...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx6f2c17562ccb51c2',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'bf290323fd779ba8a77a32a1a925688a',
  ...
  USERS: [
    {
      ...
      id: 'o-Y0X6Mu20kBmZQ0g1nnTagAKu0Q	移除',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'iCrw6aXrzwV4RTwIll7ty5x5zP7ll-8bkCgQlzmTqoc',
      // 所在省份
      province: '山东',
      // 所在城市
      city: '日照',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '许先生', year: '2000', date: '12-16',
        },
        {
        ...
        {
          type: '生日', name: '许彤辉', year: '2001', date: '01-10',
        },
        {
  ...
  CALLBACK_TEMPLATE_ID: 'yEDtuF3kbv_vLAY8wssV0u9aMwbdQLBEbO9n5rQg79k',
  ...
  CALLBACK_USERS: [
    {
      ...
      id: 'o-Y0X6Mu20kBmZQ0g1nnTagAKu0Q',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
